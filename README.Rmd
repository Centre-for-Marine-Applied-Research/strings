...
`strings` was developed specifically to streamline CMAR’s workflow, but is flexible enough that other users can apply it to process data from the accepted sensors (Table 1). Refer to vignettes for more detail.

```{r, echo=FALSE,caption= "Sensor Models included"}

tibble(
  "Sensor" = c("[HOBO Pro V2](https://www.onsetcomp.com/datasheet/U22-001)", "[HOBO DO](https://www.onsetcomp.com/datasheet/U26-001)", "[aquaMeasure DOT](https://www.innovasea.com/wp-content/uploads/2021/07/Innovasea-Aquaculture-Intelligence-Spec-Sheet-062221.pdf)", "[aquaMeasure SAL](https://www.innovasea.com/wp-content/uploads/2021/07/Innovasea-Aquaculture-Intelligence-Spec-Sheet-062221.pdf)", "[VR2AR](https://www.innovasea.com/wp-content/uploads/2021/06/Innovasea-Fish-Tracking-vr2ar-data-sheet-0621.pdf)")
) %>% 
kable(align = "lcc")

```

Processed data from CMAR’s Coastal Monitoring Program can be viewed and downloaded from several sources, as outlined below (Figure 2).

[](https://github.com/Centre-for-Marine-Applied-Research/strings/blob/master/man/figures/Data Access Cheat Sheet 20210913.pdf)

[](man/figures/Data Access Cheat Sheet 20210913.pdf)

```{r, echo=FALSE, out.width="65%", fig.align='center',fig.cap="\\label{fig:figs}Figure 2: Data access cheat sheet"}

knitr::include_graphics("https://github.com/Centre-for-Marine-Applied-Research/strings/blob/master/man/figures/Data Access Cheat Sheet 20210913.pdf")
