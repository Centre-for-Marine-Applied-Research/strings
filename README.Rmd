...
```{r, echo=FALSE, out.width="65%", fig.align='center',fig.cap="\\label{fig:figs}Typical sensor string"}
...
`strings` was developed specifically to streamline CMAR’s workflow, but is flexible enough that other users can apply it to process data from the accepted sensors (Table? (Yes, lets make a table)). Refer to vignettes for more detail.
